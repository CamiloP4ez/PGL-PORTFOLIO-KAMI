...
import { Picker } from "@react-native-picker/picker"; // Asegúrate de instalar esta librería: `npm install @react-native-picker/picker`
...
export default function ShoppingForm({ product, onSave, onCancel }: Props) {
  ...
  const handleSave = () => {
    ...
    onSave({
      ...
      inCart: product?.inCart || false, // Si estamos editando, conservamos este estado
    });
    ...
    <View style={styles.container}>
      ...
      <View style={styles.pickerContainer}>
        ...
        >
          ...
          <Picker.Item label="Carnes" value="meats" />
          <Picker.Item label="Pescados" value="seafood" />
          <Picker.Item label="Frutas y Verduras" value="produce" />
...
const styles = StyleSheet.create({
  ...
  pickerContainer: {
    ...
    borderRadius: 8,
    marginBottom: 15,
    overflow: "hidden", // Para que se ajuste en iOS
  },
  buttonContainer: {
    flexDirection: "row",
